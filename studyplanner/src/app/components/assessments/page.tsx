            ...
            {assessments.map((assignment) => (
              <li key={assignment.id} className="">
                <div className='flex justify-between gap-x-6 py-5'>
                  ...
                  <div className="flex sm:hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                ...
                <div>
                  <p className=" text-left text-xs leading-6 text-white">Description: {assignment.Description}</p>
                </div>
